-- Fix the handle_new_user trigger to use correct column name 'name' instead of 'legal_name'
...
BEGIN
  ...
  -- Owner path: create company with correct column name 'name' (not 'legal_name')
